...
HD_PWD='C:/Users/82106/Documents/GitHub/ECE_exp2/week11/text_LCD/text_LCD_shift/text_LCD_shift/text_LCD_shift.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log text_LCD_shift.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source text_LCD_shift.tcl
