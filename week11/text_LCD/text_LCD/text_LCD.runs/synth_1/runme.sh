...
HD_PWD='C:/Users/82106/Documents/GitHub/ECE_exp2/week11/text_LCD/text_LCD/text_LCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log text_LCD_basic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source text_LCD_basic.tcl
