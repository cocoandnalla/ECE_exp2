...
HD_PWD='C:/Users/82106/Documents/GitHub/ECE_exp2/week11/text_LCD/text_LCD/text_LCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log text_LCD_basic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source text_LCD_basic.tcl -notrace
