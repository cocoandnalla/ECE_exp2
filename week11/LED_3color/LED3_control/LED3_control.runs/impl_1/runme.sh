...
HD_PWD='C:/Users/82106/Documents/GitHub/ECE_exp2/week11/LED_3color/LED3_control/LED3_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED3_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED3_control.tcl -notrace
