...
HD_PWD='C:/Users/82106/Documents/GitHub/ECE_exp2/week11/LED_3color/LED3_control/LED3_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED3_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED3_control.tcl
