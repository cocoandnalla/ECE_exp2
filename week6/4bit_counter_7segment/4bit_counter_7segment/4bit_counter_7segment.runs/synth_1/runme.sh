...
HD_PWD='C:/Users/82106/Documents/GitHub/ECE_exp2/week6/4bit_counter_7segment/4bit_counter_7segment/4bit_counter_7segment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_array.tcl
