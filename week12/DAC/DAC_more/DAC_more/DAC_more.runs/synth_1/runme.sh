...
HD_PWD='C:/Users/82106/Documents/GitHub/ECE_exp2/week12/DAC/DAC_more/DAC_more/DAC_more.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_more.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dac_more.tcl
